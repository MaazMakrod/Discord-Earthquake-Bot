...
async def on_message(message):
    ...
    if message.content.startswith('$earthquake'):
        ...
        response = "%s \n\n_All information is from_ `https://www.volcanodiscovery.com/earthquakes/today.html`" % text[
            start:end]
